...
#### api documentation for  [ipfs (v0.23.1)](https://github.com/ipfs/js-ipfs#readme)  [![npm package](https://img.shields.io/npm/v/npmdoc-ipfs.svg?style=flat-square)](https://www.npmjs.org/package/npmdoc-ipfs) [![travis-ci.org build-status](https://api.travis-ci.org/npmdoc/node-npmdoc-ipfs.svg)](https://travis-ci.org/npmdoc/node-npmdoc-ipfs)
...
![npmPackageListing](https://npmdoc.github.io/node-npmdoc-ipfs/build/screenCapture.npmPackageListing.svg)

![npmPackageDependencyTree](https://npmdoc.github.io/node-npmdoc-ipfs/build/screenCapture.npmPackageDependencyTree.svg)
